...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    ...
    <div class="card hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ number_format($dailyStats->sum('total_conversations')) }}</p>
            </div>
    ...
    <div class="card hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-600 mb-1">Utilisateurs Uniques</p>
                <p class="text-3xl font-bold text-gray-900">{{ number_format($dailyStats->sum('unique_users')) }}</p>
            </div>
    ...
    <div class="card hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-600 mb-1">Taux de Transfert</p>
                @php
    ...
    <div class="card hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-600 mb-1">Durée Moyenne</p>
                @php
                    $avgDuration = $dailyStats->avg('avg_session_duration_seconds');
                @endphp
                <p class="text-3xl font-bold text-yellow-600">{{ $avgDuration ? gmdate('i:s', $avgDuration) : 'N/A' }}</p>
            </div>
    ...
    <div class="card">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900">{{ number_format($dailyStats->sum('clients_count')) }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900">{{ number_format($dailyStats->sum('non_clients_count')) }}</p>
            </div>
        </div>
    </div>
