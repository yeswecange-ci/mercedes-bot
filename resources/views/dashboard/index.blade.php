    ...
    <div class="card hover:shadow-md transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ number_format($stats['completed_conversations']) }}</p>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="card">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Distribution des menus</h3>
    ...
    <!-- Daily Trend Chart -->
    <div class="card">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Tendance quotidienne</h3>
        <div class="relative h-64">
...
<div class="card">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('dashboard.conversations') }}" class="text-sm font-medium text-primary-600 hover:text-primary-700 transition-colors duration-200">
            Voir tout →
        </a>
    </div>
